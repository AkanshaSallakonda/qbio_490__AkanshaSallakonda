...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/akki/Desktop/USC/FreshmanYear/QBIO490/qbio_490_AkanshaSallakonda")) 
```
...
```{r Exercise 3.4}
## add code here!
name <- "Akansha Sallakonda"
age <- "18"
birthday <- "03/07/2005"
three_fav_colors <- "yellow, coral, aquamarine"
...
sum_list_of_numbers <- sum(list_of_numbers)
min_list_of_numbers <- min(list_of_numbers)
mean_list_of_numbers <- mean(list_of_numbers)
mode_list_of_numbers <- mode(list_of_numbers)
summary_list_of_numbers <- summary(list_of_numbers)
sum_list_of_numbers
min_list_of_numbers
mean_list_of_numbers
mode_list_of_numbers
summary_list_of_numbers
```
...
# write code here
mtcars$transmission
ifelse(mtcars$transmission, yes, no)
...
```{r Exercise 9.4}
mtcars_copy <- mtcars["mpg","cyl","disp","hp","drat","wt","qsec","vs","am","gear","carb"]
```
